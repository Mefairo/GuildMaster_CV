...
public class MageAbility_1_2_2 : ActivateHeroAbility
{
    public MageAbility_1_2_2(Ability ability) : base(ability)
    {
    }
    ...
    public override float ActivateAttackAbility(HeroQuestSlot_UI heroSlot, Ability ability, QuestSlot_UI questSlot, List<HeroQuestSlot_UI> heroesSlots)
    {
        ...
        //if (_ability.AbilityData is MageAbilityData_1_2_2 abilityData)
        //{
        //    float hasteBonusPower = heroSlot.Hero.HeroStats.CritMulti * (heroSlot.Hero.PowerPoints * abilityData.CritCoef / 100); // 100% - это проценты
